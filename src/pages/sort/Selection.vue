<template>
    <div class="parent">
        <div class="array">
            <div class="type">
                <el-button icon="el-icon-sort-up" @click="sortUp" round>升序</el-button>
                <el-button icon="el-icon-refresh" @click="sortRand" round>乱序</el-button>
                <el-button icon="el-icon-sort-down" @click="sortDown" round>降序</el-button>
            </div>
            <div class="numbers">
                <el-button
                    @click="toggleArray(i)"
